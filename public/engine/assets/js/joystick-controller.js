 ...
 */
class DynamicJoystickController {
  /**
    ...
    this.style.innerHTML = `
      ...
      this.options.dynamicPosition || !this.options.bottomToUp ? "-50%" : "50%"
        ...
        .joystick-controller-${this.id} {
            ...
            border-radius: 50%;
            position: relative;
            <!-- background-image: url(./assets/images/stickcontrolbase.png); -->
            background-position: center;
            background-size: cover;
            outline: 1px dashed white;
            box-shadow: rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset;
            <!-- outline: 0px solid #4c4c4c77; -->
  ...
  dynamicPositioningMouse = (e) => {
    ...
    const x = e.clientX / this.options.pageScale;
    const y = e.clientY / this.options.pageScale;
  ...
  dynamicPositioningTouch = (event) => {
    ...
    if (!touch) return;
    const x = touch.clientX / this.options.pageScale;
    const y = touch.clientY / this.options.pageScale;
    this.container.style.left = x + "px";
    this.container.style.top = y + "px";
    this.container.style.bottom = "unset";
    this.container.style.right = "unset";
  ...
  onTouchEvent = (event) => {
    ...
    event.preventDefault();
    // position of touch
    const x = touch.clientX - this.options.pageScale * this.options.joystickRadius / 2;
    const y = touch.clientY - this.options.pageScale * this.options.joystickRadius / 2;
    // update coordinates
...
export default DynamicJoystickController;
